  ...
  return (
    <Layout>
      ...
      >
        ...
        <Display>
          <Wordmark colors={[null, brand.COLOR_PRIMARY]} />
        </Display>
        <Display>
          <Wordmark colors={[null, brand.COLOR_SECONDARY]} />
        </Display>
        <Display>
          <Wordmark colors={[null, brand.COLOR_TERTIARY]} />
        </Display>
        <Display>
          <Wordmark colors={[null, brand.COLOR_QUARTERLY]} />
        </Display>
        <Display>
          <Wordmark color={brand.COLOR_PRIMARY} />
        </Display>
        <Display>
          <Wordmark color={brand.COLOR_SECONDARY} />
        </Display>
        <Display>
          <Wordmark color={brand.COLOR_TERTIARY} />
        </Display>
        <Display>
          <Wordmark color={brand.COLOR_QUARTERLY} />
        </Display>
      </div>
